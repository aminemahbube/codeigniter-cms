...
class Galleries extends CI_Controller
{
    ...
    public function save(){
        ...
        if($validate){
            ...
            /* klasör oluşturma komutunu mkdir ile yapıyoruz 3 parametre alır
            birincisi path klasör adı
            ikincisi modu yani yazma izinleri */
            if($gallery_type != "video"){
                //İşlem başarılı mı mkdir ile cevabı boolean değeri olarak döner
                if(!mkdir($path, 0755)){
                    //video harici klasör oluşturamazsak bu hatayı vercek
                    $alert = array(
