...
class Galleries extends CI_Controller
{
    ...
    public function update($id, $gallery_type, $oldFolderName = ""){
        ...
        if($validate){
            ...
            if($gallery_type != "video"){
                //1. parametre eski klasör yolu 2. parametresi yeni klasör yolu 
                //klasör ismi güncelleme
    ...
    //  GALERİ ELEMANLARI İÇİN KULLANILAN ELEMANLAR
